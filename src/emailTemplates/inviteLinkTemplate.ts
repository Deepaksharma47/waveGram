export const loginInviteTemplate = (link: string,receiverName:string, sender: string) =>  (`
    <!doctype html>
<html lang="en">
  <head>
      ...
      <table class="main">
        <tr>
          <td class="wrapper">
            ...
            <p>It seems you already have an account with us. Click the button below to log in and after the logged you will be a friend of ${sender} (who sent you the request)</p>
